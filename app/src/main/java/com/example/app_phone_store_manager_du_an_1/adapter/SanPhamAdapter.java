    ...
    public void onBindViewHolder(@NonNull @NotNull ViewHolder holder, int position) {
        ...
        if (daoTTSP.checkTTMaSP(sanPham.getMaSP()) > 0) {
            ...
            if (sanPham.getPhanLoai() > 0) {
                ...
                holder.tvPLSP.setText("Loại: Gia dụng  ");
                holder.tvCTSP.setText("Khối lượng: " + ttSP.getRAM() + "  -  BH: " + ttSP.getBoNho());
            }
        } else {
            holder.tvPLSP.setText("Chưa cập nhật");
            holder.tvCTSP.setText("Chưa cập nhật");
        }
